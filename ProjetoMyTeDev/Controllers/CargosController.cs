...
namespace ProjetoMyTeDev.Controllers
{
    public class CargosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CargoId,CargoNome,CargaHoraria")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CargoId,CargoNome,CargaHoraria")] Cargo cargo)
        {
            if (id != cargo.CargoId)
            {
                return NotFound();
